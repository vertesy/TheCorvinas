#!/usr/bin/python -u
'''
### 00.genome_fa_reformatter_1chr_per_line.py
...
InputDir = "~/Dokumentumok/Tanulas/PhD/AvanO/genomes/"
inGenomeName = "hg38.fa"

# Init ------------------------------------------------------
os.chdir(InputDir)
outfname = inGenomeName.rsplit('.', 1)[0] + ".reformat.clean.fa"; # print outfname
