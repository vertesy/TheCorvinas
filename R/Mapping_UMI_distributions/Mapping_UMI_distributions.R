...
setup_MarkdownReports(OutDir = "~/GitHub/TheCorvinas/R/Mapping_UMI_distributions/")


UMI_distr_in_mapped_reads = 	read.simple.tsv("~/GitHub/TheCorvinas/R/Mapping_UMI_distributions/UMI_distr_in_mapped_reads.tsv")
UMI_distr_in_unmapped_reads = 	read.simple.tsv("~/GitHub/TheCorvinas/R/Mapping_UMI_distributions/UMI_distr_in_unmapped_reads.tsv")
