...
######################################################################
# source ('/Users/abelvertesy/Github_repos/TheCorvinas/R/igraph/igraph.R')
...
# Setup ------------------------
setup_MarkdownReports(OutDir = "/Users/abelvertesy/Google_Drive/PathwayVisualisation", scriptname ="igraph.R" )
...
bsk = read.simple.tsv("/Users/abelvertesy/Google_Drive/PathwayVisualisation/bsk.tsv")
edgelist_pw_WNT_canonical = read.simple.tsv("/Users/abelvertesy/Google_Drive/PathwayVisualisation/pw_WNT_canonical.tsv")
